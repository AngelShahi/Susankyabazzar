                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 mb-6 border-t border-b border-gray-200 py-6">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 font-medium">{moment(product.createAt).fromNow()}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 font-medium">{product.numReviews}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-gray-800 font-medium">{product.countInStock}</p>
                    </div>
                  </div>
                  <div className="flex items-center">
